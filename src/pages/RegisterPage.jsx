  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      ...
      if (success) {
        ...
        // Error toast is handled by AuthContext, so just update local error if specific message is needed
      ...
      <div className="max-w-md mx-auto">
        ...
        >
          <div className="text-center mb-8">
            <img  alt="MediPharm Logo" className="h-12 w-auto mx-auto mb-4" src="https://images.unsplash.com/photo-1533040145381-ac0476e90789" />
